...
//             <Motion transition={{ duration: 0.4, delay: 0.3 }} variants={{ hidden: { opacity: 0, x: -20 }, visible: { opacity: 1, x: 0 } }} classNames={undefined}>
//               <Link className="w-fit" href="/services/iot">
//                 <li className="text-white/70 hover:text-white">IOT Development</li>
//               </Link>
//             </Motion>
//             <Motion transition={{ duration: 0.4, delay: 0.4 }} variants={{ hidden: { opacity: 0, x: -20 }, visible: { opacity: 1, x: 0 } }}  classNames={undefined}>
//               <Link className="w-fit" href="/services/ai">
//                 <li className="text-white/70 hover:text-white">AI/ML Development</li>
//               </Link>
//             </Motion>
//             <Motion transition={{ duration: 0.4, delay: 0.5 }} variants={{ hidden: { opacity: 0, x: -20 }, visible: { opacity: 1, x: 0 } }}  classNames={undefined}>
//               <Link className="w-fit" href="/services/e-commerce">
//                 <li className="text-white/70 hover:text-white">E-Commmerce Development</li>
//               </Link>
//             </Motion>
//             <Motion transition={{ duration: 0.4, delay: 0.6 }} variants={{ hidden: { opacity: 0, x: -20 }, visible: { opacity: 1, x: 0 } }} classNames={undefined}>
//               <Link className="w-fit" href="/services/ui-ux">
//                 <li className="text-white/70 hover:text-white">UI/UX Development</li>
//               </Link>
//             </Motion>
//             <Motion transition={{ duration: 0.4, delay: 0.7 }} variants={{ hidden: { opacity: 0, x: -20 }, visible: { opacity: 1, x: 0 } }} children={undefined} classNames={undefined}>
...
//               </Link>
//             </Motion>
//             <Motion transition={{ duration: 0.4, delay: 0.8 }} variants={{ hidden: { opacity: 0, x: -20 }, visible: { opacity: 1, x: 0 } }} children={undefined} classNames={undefined}>
...
//             <Motion transition={{ duration: 0.4 }} variants={{ hidden: { opacity: 0, x: -20 }, visible: { opacity: 1, x: 0 } }} children={undefined} classNames={undefined}>
//               <Link className="w-fit" href="/products/narratex">
//                 <li className="text-white/70 hover:text-white">Ai Based Products</li>
//               </Link>
//             </Motion>
//             <Motion transition={{ duration: 0.4, delay: 0.1 }} variants={{ hidden: { opacity: 0, x: -20 }, visible: { opacity: 1, x: 0 } }} children={undefined} classNames={undefined}>
//               <Link className="w-fit" href="/products">
//                 <li className="text-white/70 hover:text-white">Blockchain Based Products</li>
//               </Link>
//             </Motion>
//             <Motion transition={{ duration: 0.4, delay: 0.2 }} variants={{ hidden: { opacity: 0, x: -20 }, visible: { opacity: 1, x: 0 } }} children={undefined} classNames={undefined}>
//               <Link className="w-fit" href="/products">
//                 <li className="text-white/70 hover:text-white">Learning Management System</li>
//               </Link>
//             </Motion>
//             <Motion transition={{ duration: 0.4, delay: 0.3 }} variants={{ hidden: { opacity: 0, x: -20 }, visible: { opacity: 1, x: 0 } }} children={undefined} classNames={undefined}>
//               <Link className="w-fit" href="/products/tinytails">
//                 <li className="text-white/70 hover:text-white">Url Shortener</li>
//               </Link>
//             </Motion>
//             <Motion transition={{ duration: 0.4, delay: 0.4 }} variants={{ hidden: { opacity: 0, x: -20 }, visible: { opacity: 1, x: 0 } }} children={undefined} classNames={undefined}>
//               <Link className="w-fit" href="/products/99cents">
//                 <li className="text-white/70 hover:text-white">Domain and Web Hosting Platform</li>
//               </Link>
//             </Motion>
//             <Motion transition={{ duration: 0.4, delay: 0.5 }} variants={{ hidden: { opacity: 0, x: -20 }, visible: { opacity: 1, x: 0 } }} children={undefined} classNames={undefined}>
//               <Link className="w-fit" href="/products">
...
//         <Motion transition={{ duration: 0.4 }} variants={{ hidden: { opacity: 0, x: -30 }, visible: { opacity: 1, x: 0 } }} children={undefined} classNames={undefined}>
