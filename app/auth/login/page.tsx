        ...
        >
          ...
          <div className=" flex flex-col xl:flex-row h-full ">
            <section className="w-full h-full flex justify-center  items-center ">
              <div className="w-full max-w-2xl max-h-[840px] h-full ">
                <div className="slide-reveal w-full h-full max-w-[460px] mx-auto flex flex-col justify-between items-center md:items-start ">
                  <div className="space-y-6 w-full">
                    ...
                    >
                        ...
                        >
                          ...
                          <div className="relative group space-y-2 cursor-text w-full">
                            <input
                              id="email"
                              autoComplete="email"
                              className="text-sm border-none outline-none bg-white focus:ring-0 focus:border-none h-[30px] xl:h-[60px] w-full"
                        ...
                        >
                          ...
                          <div className="relative group space-y-2 cursor-text w-full">
                            <input
                              ...
                              className={clsx(
                                "text-sm  border-none outline-none  bg-white focus:ring-0 h-[30px] xl:h-[50px] 2xl:h-[60px] w-full"
                              )}
                              {...register("password")}
                            />
                          </div>
                      ...
                      <div className="flex justify-between items-center gap-4">
                        <div className="flex items-center space-x-2">
                          ...
                          <label
                            htmlFor="remember-me"
                            className="font-medium  xl:text-[14px] text-[12px]  text-[#12121299] leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70"
                          >
                            Remember me
                          </label>
                        </div>
                        <Link
                          ...
                          className=" text-black font-medium  xl:text-[14px] text-[12px]"
                        >
                          Forgot password?
                        </Link>
                      </div>
                    ...
                    <div className="flex items-center text-black gap-2">
                      ...
                      <span className="whitespace-nowrap text-2xl:text-[16px]  text-black font-medium  xl:text-[14px]">
                        OR
                      </span>
                      <div className="h-[2px] w-full bg-[#EFEFF4]" />
                    </div>
