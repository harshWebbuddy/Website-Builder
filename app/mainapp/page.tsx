...
const WebsiteBuilder=()=> {
  ...
  return (
    ...
    <Fragment>
      <main className="2xl:p-0 p-4 mt-40">
        <div className=" max-w-[1740px] max-h-[1080x] mx-auto justify-between  flex xl:flex-row md:flex-row lg:flex-row sm:flex-row flex-col 2xl:flex-row gap-y-4 items-center mt-20">
...
<Link href="/websitebuilding">
  <button onClick={handleCreateNewClick} className="bg-[#00A4A6] text-white text-[10px] xl:text-[14px] 2xl:text-[18px] sheen transition duration-500 px-2 2xl:px-5 py-2 2xl:py-4 rounded-xl flex items-center gap-2">
    ...
    Create new AI Website
        ...
        <div className="max-w-[1500px] w-full mx-auto grid md:grid-cols-3 grid-cols-1 xl:grid-cols-3 2xl:grid-cols-4  gap-4 mt-6">
