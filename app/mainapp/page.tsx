...
const WebsiteBuilder = () => {
 ...
 <div className="mt-40 flex flex-col xl:flex-row 2xl:flex-row justify-between gap-8 max-w-[1400px] w-full mx-auto  "> <div className="space-y-2 w-full flex flex-col 2xl:items-start xl:items-center items-center ">
  ...
  <div className="w-full flex gap-2 ">
    ...
    >
      ...
      Create new AI Website
        ...
        <div className="2xl:p-0 p-4 max-w-[1400px] w-full mx-auto grid md:grid-cols-2 grid-cols-1 xl:grid-cols-3 2xl:grid-cols-4 gap-4 mt-6">
