...
export default function ViewGeneratedWebsite() {
  ...
  const [selectedButtonColor, setSelectedButtonColor] = useState<string>("#007bff");
      ...
      if (iframeRef.current && generatedHtml) {
        ...
        if (iframeDocument) {
          ...
          iframeDocument.addEventListener('DOMContentLoaded', () => {
            ...
            if (body) {
              const existingStyles = body.querySelectorAll('style[data-dark-mode], style[data-font]');
              ...
              style.textContent = `
               @import url('https://fonts.googleapis.com/css2?family=${selectedFont.replace(/\s+/g, '+')}&display=swap');
   button {
      ...
      <main className="flex-1 h-full w-full flex flex-col mt-40 border-white">
        <div className="bg-white  flex flex-col justify-between max-w-[1668px] mx-auto w-full items-center rounded-xl  shadow  shadow-gray-100 ">
          <div className="flex px-4 flex-wrap border-b-2  rounded-xl 2xl:flex-nowrap 2xl:justify-between items-center w-full max-w-[1668px]">
           ...
           <span className="ml-4 flex flex-row justify-between w-full border border-[#E2E8F0] max-w-[518px] rounded-xl px-2">   <span className="text-[14px] flex flex-row gap-2 items-center">
              <svg width="15" height="14" viewBox="0 0 15 14" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M11.8834 6.41797H3.71672C3.07238 6.41797 2.55005 6.9403 2.55005 7.58464V11.668C2.55005 12.3123 3.07238 12.8346 3.71672 12.8346H11.8834C12.5277 12.8346 13.05 12.3123 13.05 11.668V7.58464C13.05 6.9403 12.5277 6.41797 11.8834 6.41797Z" stroke="#22C55E" stroke-width="1.16667" stroke-linecap="round" stroke-linejoin="round"/>
<path d="M4.8833 6.41797V4.08464C4.8833 3.31109 5.19059 2.56922 5.73757 2.02224C6.28455 1.47526 7.02642 1.16797 7.79997 1.16797C8.57352 1.16797 9.31538 1.47526 9.86236 2.02224C10.4093 2.56922 10.7166 3.31109 10.7166 4.08464V6.41797" stroke="#22C55E" stroke-width="1.16667" stroke-linecap="round" stroke-linejoin="round"/>
</svg>
  https://aquamarine-blythe-donkey.AIBuilder/?preview=true</span> <svg width="14" height="24" viewBox="0 0 14 24" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M11.6667 9.66797H5.83341C5.18908 9.66797 4.66675 10.1903 4.66675 10.8346V16.668C4.66675 17.3123 5.18908 17.8346 5.83341 17.8346H11.6667C12.3111 17.8346 12.8334 17.3123 12.8334 16.668V10.8346C12.8334 10.1903 12.3111 9.66797 11.6667 9.66797Z" stroke="#9CA3AF" stroke-width="1.16667" stroke-linecap="round" stroke-linejoin="round"/>
<path d="M2.33341 14.3346C1.69175 14.3346 1.16675 13.8096 1.16675 13.168V7.33464C1.16675 6.69297 1.69175 6.16797 2.33341 6.16797H8.16675C8.80841 6.16797 9.33341 6.69297 9.33341 7.33464" stroke="#9CA3AF" stroke-width="1.16667" stroke-linecap="round" stroke-linejoin="round"/>
</svg>
   </span>        </div>
