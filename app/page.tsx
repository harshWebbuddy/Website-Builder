    ...
    <main className="">
        ...
        <div className="relative flex  flex-col items-center py-16  xl:py-40 2xl:py-56 space-y-4 bg-[#0D121F] overflow-hidden">
          ...
          <div className="p-8 2xl:p-0 slide-reveal relative z-[2] w-full h-full flex flex-col space-y-8 justify-center items-center text-white">
            ...
            <div className="bg-white text-black  rounded-2xl border border-[#E8E8E8] w-full max-w-[672px] flex gap-4 shadow-md shadow-gray-200/60">
              <Image src="/logo/growstack-mini.svg" alt="" width={25} height={25} className="opacity-0" />
              <input className=" border-none  -translate-x-8 outline-none h-[49.6px] w-full" placeholder="A landing page for cozy bakery" />
          ...
          >
            <div className="flex xl:mt-2 2xl:mt-4 flex-col sm:flex-row justify-between gap-x-3 items-start">
              <div className="flex justify-between flex-col xl:flex-row 2xl:flex-row w-full">
                <h1 className="text-[20px] xl:text-[28px] 2xl:text-[40px] 2xl:leading-relaxed font-bold text-[#151515] mb-3">
      ...
      <section className="px-6 md:px-16 py-10 mb-2 xl:mb-20 2xl:mb-40 bg-white text-black">
        <div className="max-w-[1420px] mx-auto">
          ...
          <div className="mt-2 xl:mt-16 2xl:mt-20 grid grid-cols-1 lg:grid-cols-wsm:grid-cols-2 md:grid-cols-2 xl:grid-cols-2 gap-y-4 2xl:gap-x-10 gap-y-4 2xl:gap-y-10 " >
            <Motion
            ...
            >
              <div className="bg-[#FAFAFF]  group flex flex-col  p-4 gap-y-2  rounded-[10px] ">
                ...
                <p className="text-[#151515]  w-full text-[12px] ">
                  Enjoy the freedom to tweak your landing pages. Add sections, change templates, and refine text with ease – either manually or .
                </p>
