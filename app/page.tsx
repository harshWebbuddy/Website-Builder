        ...
        <section className="mb-10 brightness-125 xl:mb-16 2xl:mb-20 ">
          <div className="relative flex  flex-col items-center py-16  xl:py-40 2xl:py-56 space-y-6 bg-[#0D121F] overflow-hidden">
            ...
            <div className="max-w-[606px] flex flex-col space-y-4">
              <h2 className="text-sm text-ellipsis text-white font-medium  text-primary-black text-center 2xl:text-left 2xl:items-start 2xl:justify-start relative text-opacity-60">
            ...
            >
              <div className="flex xl:mt-2 2xl:mt-4 flex-col sm:flex-row justify-between gap-x-3 items-start">
                <div className="flex justify-between flex-col xl:flex-row 2xl:flex-row w-full">
                  <h1 className="     text-[16px]   xl:text-[28px] 2xl:text-[40px] 2xl:leading-relaxed font-bold text-[#151515] mb-3">
                  ...
                  <p className="2xl:leading-[30px] text-[#191E2A] text-[14px] xl:text-[16px] 2xl:text-[20px] md: text-[12px]text-[#151515]">
                    ...
                    are some of <br /> the reasons why you should use our
            ...
            >
              <div className="flex flex-col  mx-auto gap-x-3 items-center">
                <div className="flex flex-col ">
                  <h4 className="text-[#00A4A6] brightness-90 text-center font-light uppercase mb-3 text-[12px] xl:text-[16px] 2xl:text-[20px]">
                    FEATURES
                  </h4>
                  <h1 className="     text-[16px]   xl:text-[28px] 2xl:text-[40px] 2xl:leading-relaxed font-bold text-[#191E2A] mb-3">
                    Our AI features
                  </h1>
                </div>
              </div>
              ...
              >
                <div className="bg-[#FAFAFF]  group flex flex-col  p-4 gap-y-2 rounded-[10px] ">
                  ...
                  <p className="text-[#191E2A]w-full    text-[12px] ">
                    ...
                    Intercom, and more. Connect with your preferred email
                    marketing, CRM, or communication tools with ease.{" "}
                  </p>
                </div>
              </Motion>
            </div>
